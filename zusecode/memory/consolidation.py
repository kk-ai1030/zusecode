...
from zusecode.memory.auto_memory import ENTRYPOINT_NAME, MAX_ENTRYPOINT_LINES
from zusecode.memory.session import SessionManager
...
class MemoryConsolidator:
    ...
    def __init__(
        ...
        *,
        ...
        self._mem_dir = os.path.join(work_dir, ".zusecode", "memory")
        self._user_mem_dir = os.path.join(Path.home(), ".zusecode", "memory")
    ...
    async def _do_consolidation(
        ...
        from zusecode.tools.bash import BashTool
        from zusecode.tools.edit_file import EditFileTool
        from zusecode.tools.glob import GlobTool
        from zusecode.tools.grep import GrepTool
        from zusecode.tools.read_file import ReadFileTool
        from zusecode.tools.write_file import WriteFileTool

        transcript_dir = os.path.join(self._work_dir, ".zusecode", "sessions")
