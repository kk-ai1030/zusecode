...
PROJECT_AGENTS_DIR = ".zusecode/agents"
USER_AGENTS_DIR = "~/.zusecode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("zusecode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from zusecode.agents.parser import parse_frontmatter, _validate_agent_meta
