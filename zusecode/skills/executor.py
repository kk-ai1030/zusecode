...
from zusecode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from zusecode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from zusecode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
