...
class InstallSkillTool(Tool):
    """从 URL 下载并安装 skill 到用户全局目录 (~/.zusecode/skills/)。
    ...
    description = (
        ...
        "(~/.zusecode/skills/). Supports skills.sh URLs (https://www.skills.sh/<owner>/<repo>/<name>), "
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from zusecode.skills.install import parse_skill_url, install_skill
