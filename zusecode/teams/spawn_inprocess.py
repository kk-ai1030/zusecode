        ...
        for m in mailbox.consume(member_name):
            ...
            if (m.type == protocol.PLAN_APPROVAL_RESPONSE
                ...
                if protocol.approved(m):
                    # 批准后切回正常权限，队友可以改文件了
                    from zusecode.permissions.modes import PermissionMode
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from zusecode.conversation import ConversationManager as CM
                conv = CM()
