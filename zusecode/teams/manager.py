...
from zusecode.teams.backend_detect import BackendDetectionError, detect_backend
from zusecode.teams.mailbox import Mailbox, create_message
...
from zusecode.teams.progress import TeammateProgress
from zusecode.teams.registry import AgentNameRegistry
from zusecode.teams.shared_task import SharedTaskStore
from zusecode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from zusecode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
            elif backend_type == BackendType.ITERM2.value:
                from zusecode.teams.spawn_iterm2 import kill_pane
                kill_pane(pane_id)
