...
from zusecode.agents.parser import AgentDef, AgentParseError, parse_agent_file, parse_frontmatter
...
from zusecode.agents.fork import (
    FORK_BOILERPLATE_TAG,
    ForkError,
    build_forked_messages,
)
from zusecode.agents.trace import TraceManager, TraceNode
from zusecode.agents.task_manager import BackgroundTask, TaskManager
from zusecode.agents.notification import format_task_notification, inject_task_notifications
from zusecode.conversation import ConversationManager, Message, ToolResultBlock, ToolUseBlock
...
class TestAgentLoader:
    ...
    def test_project_overrides_builtin(self, tmp_path: Path):
        agents_dir = tmp_path / ".zusecode" / "agents"
...
class TestPermissionMode:
    def test_bypass_mode(self):
        from zusecode.permissions.modes import PermissionMode, mode_decide
...
class TestAgentToolParams:
    def test_required_fields(self):
        from zusecode.tools.agent_tool import AgentToolParams
