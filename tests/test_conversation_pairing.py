...
from zusecode.conversation import Message, ToolResultBlock, ToolUseBlock
from zusecode.conversation_pairing import INTERRUPTED_TOOL_RESULT, ensure_tool_pairing
